...
```
### <font color = pink>拷贝构造调用时机（什么时候用到拷贝构造）</font>
...
>>* 静态成员函数只能访问静态成员变量
### <font color = pink>C++对象模型（成员变量和成员函数分开存储）</font>
...
```
### <font color = pink>空指针访问成员函数</font>
### <font color = pink>const 修饰成员函数</font>
mutable 可以改常函数
# 2025.1.15
### <font color = pink>友元</font>
...
父类：基类
```
### <font color = pink>开发人员命令提示查看对象模型</font>
### <font color = pink>多继承</font>
### <font color = pink>virtual 虚继承</font>
### <font color = pink>文件流</font>
* 虚基类
# <font color = skyblue>CPP提高编程（模板与泛型编程）</font>
### <font color = pink>模板</font>
### <font color = pink>STL - standard template library（标准模板库）</font>
STL 分类
```
1、容器
2、算法
